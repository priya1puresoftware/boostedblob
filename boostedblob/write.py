...
from .request import Request, RequestFailure, azurify_request, googlify_request, exponential_sleep_generator
        ...
        async with request.execute() as resp:
            ...
            if result["Error"]["Code"] == "InvalidBlockList":
                if attempt >= 3:
                    ...
                    # It turns out when using unordered upload, that these actually succeed on
                    # retry. I guess it means we're just going too fast...
